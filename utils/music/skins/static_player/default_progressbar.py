...
class DefaultProgressbarStaticSkin:
    ...
    def __init__(self):
        ...
        self.preview = "https://cdn.discordapp.com/attachments/1162795987014787162/1221134066061938759/image.png?ex=661178b8&is=65ff03b8&hm=def59547e404f15ccb7c90bad3b38c70fdca13b3397080c97bbb21faa0b6abbd&"
    ...
    def load(self, player: LavalinkPlayer) -> dict:
        ...
        if player.current.is_stream:
            duration = "```ansi\n<:tec_live:1216397982602231859> [31;1m Livestream[0m```"
        else:
            ...
            duration = f"```ansi\n[34;1m[{time_format(player.position)}] {('='*progress.start)}[0m<:tec_live:1216397982602231859>️[36;1m{'-'*progress.end} " \
        ...
        if player.current.track_loops:
            txt += f"\n> <:tec_Loop:1216406941191114793> **⠂Remaining Loops:** `{player.current.track_loops}`"
