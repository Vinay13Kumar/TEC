        ...
        if self.bot.config["SUPPORT_SERVER"]:
            self.components.append(
                disnake.ui.Button(
                    ...
                    emoji="<a:tec_desktop:1213035097838592020>"
                )
            )
